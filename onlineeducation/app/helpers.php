...
echo $response;
 ...
 function sendPushNotification($registatoin_ids,$title,$body,$customData)
 {

    $url = "https://fcm.googleapis.com/fcm/send";
    $token = $registatoin_ids;
    $serverKey = 'AAAAgAoNCqg:APA91bEyoukOpJWmYPJ8Ov08NRziswIh6syPovXSqMI_MwBB4roMfQ-BAng_vHgRw63rdb8EUY3Si7mM34iN60rfs3ASL2cKihuCB174knBOaAdO6mF4CuPos1WBGfQ7rbHfrf8J6Z79';
    $notification = array('title' =>$title , 'body' => $body, 'sound' => 'default', 'badge' => '1');
    $arrayToSend = array('to' => $token, 'notification' => $notification,'priority'=>'high',"data" => $customData);
 ...
 function getPlan()
 {
      ...
      CURLOPT_HTTPHEADER => array(
        "Authorization: Basic cnpwX3Rlc3RfVTlJbU1TZEFnZWJVSFk6MDBaNmFjME9xeDBiTVVzbE1EdXpMWHp4"
      ),
    ));
