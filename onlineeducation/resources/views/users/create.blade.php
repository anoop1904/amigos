          ...
          <div class="row">
            ...
            <div class="col-md-4">
              ...
              <div class="form-group">
               ...
               <select class="form-control select2" name="course[]" multiple="" required="">
                    <option value="all" >Select Course</option>
                    @foreach($courseList as $key => $course)
                        <option  value="{{$course->id}}" @if(in_array($course->id,$course_ids)) selected @endif>{{$course->name}}</option>
                     @endforeach
                  </select>
                </div>
              </div>
