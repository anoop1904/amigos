<!--begin::Aside side menu-->
<?php 
$permissions=getAllPermissions();
// print_r($permissions);
$userpermission=getRolePermissions(Auth::user()->user_type);
?>
            ...
            <div
               ...
               <ul class="menu-nav ">
                  ...
                  @if(!empty($permissions))
                     ...
                     @php   
                        $childmenu=getAllChildPermissions($permission->id);   
                     @endphp
                      ...
                      <li class="menu-item menu-item-submenu" aria-haspopup="true">
                          ...
                          @else
                          <a href="{{URL($permission->url)}}" class="menu-link ">
                          @endif
                            ...
                            <span class="svg-icon menu-icon">
                              ...
                              <!--end::Svg Icon-->
                                    ...
                                    <span class="menu-text">{{$permission->name}}
                                       @if(count($childmenu)>0)
                                ...
                                <div class="menu-submenu" kt-hidden-height="80" style="">
                                    ...
                                    <ul class="menu-subnav">
                                       @foreach($childmenu as $submenu)
                                       @if(in_array($submenu->id,$userpermission))
                                           <li class="menu-item" aria-haspopup="true">
                                          <a href="{{URL($submenu->url)}}" class="menu-link active">
                 ...
                 @if(AUth::user()->user_type == '1')
                  ...
                  <li class="menu-item  menu-item-submenu" aria-haspopup="true"  data-menu-toggle="hover">
                     <a  href="{{URL('admin/roles')}}" class="menu-link menu-toggle">
                        <span class="svg-icon menu-icon">
                  ...
                  <li class="menu-item  menu-item-submenu" aria-haspopup="true"  data-menu-toggle="hover">
                     <a  href="{{URL('admin/permissions')}}" class="menu-link menu-toggle">
                        <span class="svg-icon menu-icon">
