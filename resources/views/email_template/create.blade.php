    ...
    <div class="col-lg-12">
      <div class="card m-b-30">
        <div class="card-body">
           ...
           {{ Form::model($email_temp, array('route' => array('emailtemplate.update', $email_temp->id), 'method' => 'PUT', 'id' => 'storeForm',  'enctype'=>'multipart/form-data')) }} 
            
            <?php  
                $template_title    = $email_temp->title;
                $ckeditor          = $email_temp->body;
                $subject           = $email_temp->subject;
                $image             = $email_temp->background_img;				
            ?>
            {!! Form::hidden('id',$email_temp->id) !!}
           ...
           <div class="col-md-4">
              <div class="form-group">
               ...
               <span class="text text-danger">*</span>
                ...
                <div>
               {{ Form::text('template_title', $template_title, array('class' => 'form-control','placeholder'=>'Template Title','id'=>$template_title)) }}
                </div>
        ...
        <div class="col-md-4">
              <div class="form-group">
               ...
               <span class="text text-danger">*</span>
                ...
                <div>
               {{ Form::text('subject', $subject, array('class' => 'form-control','placeholder'=>'Subject','id'=>$subject)) }}
                </div>
          @if ($errors->has('title')) <p class="help-block text text-danger"  >{{ $errors->first('title') }}</p> @endif
               </div>
      </div>
           ...
           {{ Form::label('Background Image', 'Background Image(optional)') }}
              <span class="text text-danger">*</span>
                    <div> 
                      <?php
                        ...
                        if($image){
                        $url = 'public/assets/img/email_temp_background/'.$image;
                        }
                      ?>
            ...
            <div class="form-group m-b-0">
              <div>
                ...
                <a href="{{ URL('admin/emailtemplate') }}" type="reset" class="btn btn-secondary waves-effect m-l-5"> Cancel </a>
              </div>
            </div>
         {!! Form::close() !!}
        </div>  
