        ...
        <div class="card card-custom">
           ...
           <div class="card-header flex-wrap border-0 pt-6 pb-0">
              ...
              <div class="card-toolbar">
                 ...
                 <!--begin::Button-->
                 <a href="{{ URL('admin/banner/create') }}" class="btn btn-primary font-weight-bolder">
          ...
          <table class="table" id="myTable" style="margin-top: 20px;">
            <thead>
              <tr>
                ...
                <th width="10%">Second Caption</th>
                <th width="10%">Third Caption</th>
           ...
           @php $count = 1; @endphp
            ...
            <tr>
                    <td>
                          ...
                          if($value->image){
                          $url = '/public/assets/img/banner/'.$value->image;
                          }
                          ?>
                    ...
                    <td>{{ $value->title }}</td>
                    <td>{{ $value->caption }}</td>
                    <td>{{ $value->secondCaption }}</td>
                    <td>{{ $value->thirdCaption }}</td>
                    <td>
                        @if($value->IsActive)
                    ...
                    <td>
                       <a href="{{ route('banner.edit', $value->id) }}" class="btn btn-info pull-left fa fa-pencil-square-o" style="margin-right: 3px;" title="Edit"></a>

                   {{ Form::open(['method' => 'DELETE', 'route' => ['banner.destroy', $value->id] ]) }}
