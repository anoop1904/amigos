        ...
        <div class="card card-custom">
           ...
           <div class="card-header flex-wrap border-0 pt-6 pb-0">
              ...
              <div class="card-toolbar">
                 ...
                 <!--end::Dropdown-->
                 <!--begin::Button-->
                 <a href="{!!URL('admin/unit/create')!!}" class="btn btn-primary font-weight-bolder">
          ...
          {{-- @if(in_array("19", $modulePermission)) --}}
           <form class="kt-form kt-form--fit mb-15" method="get">
                      <div class="row">
                        ...
                        </button>&nbsp;&nbsp;  <a class="btn btn-danger btn-secondary--icon" id="kt_reset" href="<?php echo URL('/') ?>/admin/unit">
                          <span>
            ...
            @php $count = 1; @endphp
              @foreach ($categories as $key=> $value)
                <tr>
                        ...
                        <a href="{{ route('unit.edit', $value->id) }}" class="btn btn-info pull-left fa fa-pencil-square-o" style="margin-right: 3px;" title="Edit"></a>

        
                      
                       {{-- @endif --}}
                       {{-- @if(in_array("20", $modulePermission)) --}}
                       {{ Form::open(['method' => 'DELETE', 'route' => ['unit.destroy', $value->id] ]) }}
