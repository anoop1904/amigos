        ...
        <div class="card card-custom">
           ...
           <div class="card-header flex-wrap border-0 pt-6 pb-0">
              ...
              <div class="card-toolbar">
                <!--end::Dropdown-->
                 <!--begin::Button-->
                 <a href="{!!URL('admin/brand/create')!!}" class="btn btn-primary font-weight-bolder">
          ...
          {{-- @if(in_array("19", $modulePermission)) --}}
               ...
               <form class="kt-form kt-form--fit mb-15" method="get">
                      <div class="row">
                        ...
                        </button>&nbsp;&nbsp;  <a class="btn btn-danger btn-secondary--icon" id="kt_reset" href="<?php echo URL('/') ?>/admin/brand">
                          <span>
        ...
        <table class="table" id="myTable" style="margin-top: 20px;">
           ...
           @php $count = 1; $link=''; @endphp
            ...
            <tr>
                    ...
                    <a href="{{ route('brand.edit', $user->id) }}" class="btn btn-info pull-left fa fa-pencil-square-o" style="margin-right: 3px;" title="Edit"></a>
                  
                   {{-- @endif --}}
                   {{-- @if(in_array("20", $modulePermission)) --}}
                   {{ Form::open(['method' => 'DELETE','style'=>'width: 30%;float: left;', 'route' => ['brand.destroy', $user->id] ]) }}
            ...
            <tr>
             ...
             if(isset($_GET['name'])&& isset($_GET['category']))
               {
               ?>
                 {{ $brands->appends(['name' => $_GET['name'],'category' => $_GET['category']])->links() }}
              <?php  }
             else
             {
              ?>
